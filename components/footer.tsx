    ...
    <footer style={{ borderTop: "1px solid rgba(0,212,255,0.1)", backgroundColor: "#111827" }}>
      <div className="site-wrap" style={{ padding: "3.5rem 1.5rem 2.5rem" }}>
        <div style={{ display: "grid", gridTemplateColumns: "1fr auto", gap: "2rem", alignItems: "flex-start" }}>
          <div>
            <div style={{ fontFamily: "var(--font-display)", fontWeight: 800, fontSize: "1.2rem", letterSpacing: "-0.02em", marginBottom: "0.5rem" }}>
            ...
            {PERSON.available && (
              <div style={{ display: "flex", alignItems: "center", gap: "0.5rem", marginTop: "1.25rem", fontSize: "0.75rem", color: "var(--color-ink-secondary)" }}>
                <span style={{ width: "7px", height: "7px", borderRadius: "50%", backgroundColor: "#22c55e", animation: "pulse-dot 2s ease-in-out infinite", flexShrink: 0 }} />
          ...
          <nav style={{ display: "flex", flexDirection: "column", gap: "0.625rem", alignItems: "flex-end" }}>
            {NAV_LINKS.map((link) => (
              <Link key={link.href} href={link.href}
                style={{ fontSize: "0.75rem", letterSpacing: "0.1em", textTransform: "uppercase", color: "var(--color-ink-secondary)", transition: "color 0.2s" }}
