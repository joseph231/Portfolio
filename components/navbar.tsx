...
import { NAV_LINKS, SOCIALS, PERSON } from "@/lib/data";
    ...
    <>
      <header style={{
        ...
        <div className="site-wrap" style={{
          ...
          height: scrolled ? "64px" : "72px", transition: "height 0.3s ease",
        }}>
          {/* Logo */}
          <Link href="/">
            <div style={{
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "0.5rem" }}>
            <div style={{ display: "flex", gap: "0.4rem" }} className="hide-on-mobile">
              ...
              <a href={SOCIALS.instagram} target="_blank" rel="noopener noreferrer" className="social-icon" title="Instagram"><InstagramIcon /></a>
              <a href={SOCIALS.whatsapp}  target="_blank" rel="noopener noreferrer" className="social-icon" title="WhatsApp"><WhatsAppIcon /></a>
            </div>

            <button onClick={() => setMenuOpen(!menuOpen)} className="show-on-mobile"
              style={{ padding: "0.4rem", color: "var(--color-ink)", display: "flex", alignItems: "center" }}
        ...
        <div className="animate-fade-in" style={{
          ...
          <nav style={{ display: "flex", flexDirection: "column", gap: "0.25rem", flex: 1 }}>
            {NAV_LINKS.map((link, i) => (
              <Link key={link.href} href={link.href} style={{
                ...
                color: pathname === link.href ? "var(--color-brand-blue)" : "var(--color-ink)",
                letterSpacing: "-0.02em", padding: "0.625rem 0",
          ...
          {PERSON.available && (
            <div style={{
              ...
              gap: "0.5rem", fontSize: "0.75rem", color: "var(--color-ink-secondary)",
            }}>
              <span style={{
